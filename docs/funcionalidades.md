...
| WA-COM-008 | WhatsApp comercial | Guia en pantalla y documentacion operativa | MVP | P2 | Checklist Meta lateral en `/integrations/whatsapp` explica datos necesarios y orden de validacion sin exponer secretos; documentado en `docs/ux-ajustes-operativos.md` | Mantener checklist compacto al ampliar integraciones. |

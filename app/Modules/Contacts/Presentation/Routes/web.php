...
use App\Modules\Contacts\Presentation\Controllers\ContactImportController;
use App\Modules\Contacts\Presentation\Controllers\ContactMergeController;
...
Route::get('/contacts/import', [ContactImportController::class, 'create'])->name('contacts.import.create')->middleware('can:create,'.\App\Modules\Contacts\Infrastructure\Persistence\Models\Contact::class);
Route::post('/contacts/import', [ContactImportController::class, 'store'])->name('contacts.import.store')->middleware('can:create,'.\App\Modules\Contacts\Infrastructure\Persistence\Models\Contact::class);
Route::get('/contacts/import/errors', [ContactImportController::class, 'downloadErrors'])->name('contacts.import.errors')->middleware('can:create,'.\App\Modules\Contacts\Infrastructure\Persistence\Models\Contact::class);
...
Route::post('/contacts/{contact}/merge', [ContactMergeController::class, 'store'])->name('contacts.merge')->middleware('can:admin.access');

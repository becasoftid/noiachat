...
Route::get('/health', HealthController::class)->name('health.index')->middleware('can:platform.access');
Route::get('/reports/exports/audit-logs', [ReportExportController::class, 'auditLogs'])->name('reports.exports.audit-logs')->middleware(['can:viewAny,'.AuditLog::class, 'feature:audit.view']);

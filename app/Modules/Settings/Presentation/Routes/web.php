...
Route::get('/settings', [SettingsController::class, 'index'])->name('settings.index')->middleware(['can:admin.access', 'feature:settings.whatsapp_channel']);
Route::put('/settings/channels/{channel}', [SettingsController::class, 'updateChannel'])->name('settings.channels.update')->middleware(['can:admin.access', 'feature:settings.whatsapp_channel']);

Route::middleware(['can:admin.access', 'feature:whatsapp.templates'])->group(function (): void {
